...
public class ShowroomManagement {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			List<Vehicle> showroom = populateShowroom(); // size=0,init capa=10
			boolean exit = false;
			...
			while (!exit) {
				...
				try {
					...
					case 7:
						...
						VehiclePriceComparator vpc = new VehiclePriceComparator();
						System.out.println("Sorted successfully");
						Collections.sort(showroom, vpc);
					...
					case 9:
						Collections.sort(showroom, new Comparator<Vehicle>() {
							...
							public int compare(Vehicle o1, Vehicle o2) {
								System.out.println("in ano inner : date n price");
